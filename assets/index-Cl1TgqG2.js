...
`,`
FIREBASE: `))}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const e of this.listens.values())for(const n of e.values())this.sendListen_(n);for(let e=0;e<this.outstandingPuts_.length;e++)this.outstandingPuts_[e]&&this.sendPut_(e);for(;this.onDisconnectRequestQueue_.length;){const e=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(e.action,e.pathString,e.data,e.onComplete)}for(let e=0;e<this.outstandingGets_.length;e++)this.outstandingGets_[e]&&this.sendGet_(e)}sendConnectStats_(){const e={};let n="js";e["sdk."+n+"."+bv.replace(/\./g,"-")]=1,Ud()?e["framework.cordova"]=1:rv()&&(e["framework.reactnative"]=1),this.reportStats(e)}shouldReconnect_(){const e=wl.getInstance().currentlyOnline();return cc(this.interruptReasons_)&&e}}zt.nextPersistentConnectionId_=0;zt.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let au;const Er={};class bt{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return T(Er&&se,"ChildrenNode.ts has not been loaded"),au=au||new bt({".priority":Er},{".priority":se}),au}get(e){const n=ti(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof Ue?n:null}hasIndex(e){return Yt(this.indexSet_,e.toString())}addIndex(e,n){T(e!==Vr,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const r=[];let i=!1;const s=n.getIterator(B.Wrap);let o=s.getNext();for(;o;)i=i||e.isDefinedOn(o.node),r.push(o),o=s.getNext();let l;i?l=El(r,e.getCompare()):l=Er;const a=e.toString(),u=Object.assign({},this.indexSet_);u[a]=e;const c=Object.assign({},this.indexes_);return c[a]=l,new bt(c,u)}addToIndexes(e,n){const r=pl(this.indexes_,(i,s)=>{const o=ti(this.indexSet_,s);if(T(o,"Missing index implementation for "+s),i===Er)if(o.isDefinedOn(e.node)){const l=[],a=n.getIterator(B.Wrap);let u=a.getNext();for(;u;)u.name!==e.name&&l.push(u),u=a.getNext();return l.push(e),El(l,o.getCompare())}else return Er;else{const l=n.get(e.name);let a=i;return l&&(a=a.remove(new B(e.name,l))),a.insert(e,e.node)}});return new bt(r,this.indexSet_)}removeFromIndexes(e,n){const r=pl(this.indexes_,i=>{if(i===Er)return i;{const s=n.get(e.name);return s?i.remove(new B(e.name,s)):i}});return new bt(r,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vp=10*1e3,SN=30*1e3,IN=5*60*1e3;class TN{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new CN(e);const r=Vp+(SN-Vp)*Math.random();Ji(this.reportStats_.bind(this),Math.floor(r))}reportStats_(){const e=this.statsListener_.get(),n={};let r=!1;He(e,(i,s)=>{s>0&&Yt(this.statsToReport_,i)&&(n[i]=s,r=!0)}),r&&this.server_.reportStats(n),Ji(this.reportStats_.bind(this),Math.floor(Math.random()*2*IN))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zR="repo_interrupt",BR=25;class WR{constructor(e,n,r,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=r,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new UR,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Sl(),this.transactionQueueTree_=new _h,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function VR(t,e,n){if(t.stats_=Yd(t.repoInfo_),t.forceRestClient_||Ck())t.server_=new Cl(t.repoInfo_,(r,i,s,o)=>{nm(t,r,i,s,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>rm(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{ve(n)}catch(r){throw new Error("Invalid authOverride provided: "+r)}}t.persistentConnection_=new zt(t.repoInfo_,e,(r,i,s,o)=>{nm(t,r,i,s,o)},r=>{rm(t,r)},r=>{$R(t,r)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(r=>{t.server_.refreshAuthToken(r)}),t.appCheckProvider_.addTokenChangeListener(r=>{t.server_.refreshAppCheckToken(r.token)}),t.statsReporter_=Nk(t.repoInfo_,()=>new TN(t.stats_,t.server_)),t.infoData_=new wN,t.infoSyncTree_=new Zp({startListening:(r,i,s,o)=>{let l=[];const a=t.infoData_.getNode(r._path);return a.isEmpty()||(l=da(t.infoSyncTree_,r._path,a),setTimeout(()=>{o("ok")},0)),l},stopListening:()=>{}}),Ch(t,"connected",!1),t.serverSyncTree_=new Zp({startListening:(r,i,s,o)=>(t.server_.listen(r,s,i,(l,a)=>{const u=o(l,a);qt(t.eventQueue_,r._path,u)}),[]),stopListening:(r,i)=>{t.server_.unlisten(r,i)}})}function HR(t){const n=t.infoData_.getNode(new K(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Eh(t){return IR({timestamp:HR(t)})}function nm(t,e,n,r,i){t.dataUpdateCount++;const s=new K(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(r){const a=pl(n,u=>Ee(u));o=yR(t.serverSyncTree_,s,a,i)}else{const a=Ee(n);o=vR(t.serverSyncTree_,s,a,i)}else if(r){const a=pl(n,u=>Ee(u));o=mR(t.serverSyncTree_,s,a)}else{const a=Ee(n);o=da(t.serverSyncTree_,s,a)}let l=s;o.length>0&&(l=pa(t,s)),qt(t.eventQueue_,l,o)}function rm(t,e){Ch(t,"connected",e),e===!1&&qR(t)}function $R(t,e){He(e,(n,r)=>{Ch(t,n,r)})}function Ch(t,e,n){const r=new K("/.info/"+e),i=Ee(n);t.infoData_.updateSnapshot(r,i);const s=da(t.infoSyncTree_,r,i);qt(t.eventQueue_,r,s)}function Wy(t){return t.nextWriteId_++}function GR(t,e,n,r,i){Sh(t,"set",{path:e.toString(),value:n,priority:r});const s=Eh(t),o=Ee(n,r),l=ch(t.serverSyncTree_,e),a=Ly(o,l,s),u=Wy(t),c=Py(t.serverSyncTree_,e,a,u,!0);wh(t.eventQueue_,c),t.server_.put(e.toString(),o.val(!0),(h,_)=>{const g=h==="ok";g||Ve("set at "+e+" failed: "+h);const y=Qn(t.serverSyncTree_,u,!g);qt(t.eventQueue_,e,y),YR(t,i,h,_)});const d=qy(t,e);pa(t,d),qt(t.eventQueue_,d,[])}function qR(t){Sh(t,"onDisconnectEvents");const e=Eh(t),n=Sl();kc(t.onDisconnect_,$(),(i,s)=>{const o=NR(i,s,t.serverSyncTree_,e);my(n,i,o)});let r=[];kc(n,$(),(i,s)=>{r=r.concat(da(t.serverSyncTree_,i,s));const o=qy(t,i);pa(t,o)}),t.onDisconnect_=Sl(),qt(t.eventQueue_,$(),r)}function KR(t,e,n){let r;z(e._path)===".info"?r=em(t.infoSyncTree_,e,n):r=em(t.serverSyncTree_,e,n),zy(t.eventQueue_,e._path,r)}function im(t,e,n){let r;z(e._path)===".info"?r=Ac(t.infoSyncTree_,e,n):r=Ac(t.serverSyncTree_,e,n),zy(t.eventQueue_,e._path,r)}function QR(t){t.persistentConnection_&&t.persistentConnection_.interrupt(zR)}function Sh(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),Ne(n,...e)}function YR(t,e,n,r){e&&gi(()=>{if(n==="ok")e(null);else{const i=(n||"error").toUpperCase();let s=i;r&&(s+=": "+r);const o=new Error(s);o.code=i,e(o)}})}function Vy(t,e,n){return ch(t.serverSyncTree_,e,n)||L.EMPTY_NODE}function Ih(t,e=t.transactionQueueTree_){if(e||ma(t,e),_i(e)){const n=$y(t,e);T(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&JR(t,$s(e),n)}else by(e)&&fa(e,n=>{Ih(t,n)})}function JR(t,e,n){const r=n.map(u=>u.currentWriteId),i=Vy(t,e,r);let s=i;const o=i.hash();for(let u=0;u<n.length;u++){const c=n[u];T(c.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),c.status=1,c.retryCount++;const d=Fe(e,c.path);s=s.updateChild(d,c.currentOutputSnapshotRaw)}const l=s.val(!0),a=e;t.server_.put(a.toString(),l,u=>{Sh(t,"transaction put response",{path:a.toString(),status:u});let c=[];if(u==="ok"){const d=[];for(let h=0;h<n.length;h++)n[h].status=2,c=c.concat(Qn(t.serverSyncTree_,n[h].currentWriteId)),n[h].onComplete&&d.push(()=>n[h].onComplete(null,!0,n[h].currentOutputSnapshotResolved)),n[h].unwatcher();ma(t,vh(t.transactionQueueTree_,e)),Ih(t,t.transactionQueueTree_),qt(t.eventQueue_,e,c);for(let h=0;h<d.length;h++)gi(d[h])}else{if(u==="datastale")for(let d=0;d<n.length;d++)n[d].status===3?n[d].status=4:n[d].status=0;else{Ve("transaction at "+a.toString()+" failed: "+u);for(let d=0;d<n.length;d++)n[d].status=4,n[d].abortReason=u}pa(t,e)}},o)}function pa(t,e){const n=Hy(t,e),r=$s(n),i=$y(t,n);return XR(t,i,r),r}function XR(t,e,n){if(e.length===0)return;const r=[];let i=[];const o=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],u=Fe(n,a.path);let c=!1,d;if(T(u!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)c=!0,d=a.abortReason,i=i.concat(Qn(t.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=BR)c=!0,d="maxretry",i=i.concat(Qn(t.serverSyncTree_,a.currentWriteId,!0));else{const h=Vy(t,a.path,o);a.currentInputSnapshot=h;const _=e[l].update(h.val());if(_!==void 0){yh("transaction failed: Data returned ",_,a.path);let g=Ee(_);typeof _=="object"&&_!=null&&Yt(_,".priority")||(g=g.updatePriority(h.getPriority()));const C=a.currentWriteId,p=Eh(t),f=Ly(g,h,p);a.currentOutputSnapshotRaw=g,a.currentOutputSnapshotResolved=f,a.currentWriteId=Wy(t),o.splice(o.indexOf(C),1),i=i.concat(Py(t.serverSyncTree_,a.path,f,a.currentWriteId,a.applyLocally)),i=i.concat(Qn(t.serverSyncTree_,C,!0))}else c=!0,d="nodata",i=i.concat(Qn(t.serverSyncTree_,a.currentWriteId,!0))}qt(t.eventQueue_,n,i),i=[],c&&(e[l].status=2,function(h){setTimeout(h,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(d==="nodata"?r.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):r.push(()=>e[l].onComplete(new Error(d),!1,null))))}ma(t,t.transactionQueueTree_);for(let l=0;l<r.length;l++)gi(r[l]);Ih(t,t.transactionQueueTree_)}function Hy(t,e){let n,r=t.transactionQueueTree_;for(n=z(e);n!==null&&_i(r)===void 0;)r=vh(r,n),e=Q(e),n=z(e);return r}function $y(t,e){const n=[];return Gy(t,e,n),n.sort((r,i)=>r.order-i.order),n}function Gy(t,e,n){const r=_i(e);if(r)for(let i=0;i<r.length;i++)n.push(r[i]);fa(e,i=>{Gy(t,i,n)})}function ma(t,e){const n=_i(e);if(n){let r=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[r]=n[i],r++);n.length=r,Dy(e,n.length>0?n:void 0)}fa(e,r=>{ma(t,r)})}function qy(t,e){const n=$s(Hy(t,e)),r=vh(t.transactionQueueTree_,e);return PR(r,i=>{du(t,i)}),du(t,r),My(r,i=>{du(t,i)}),n}function du(t,e){const n=_i(e);if(n){const r=[];let i=[],s=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(T(s===o-1,"All SENT items should be at beginning of queue."),s=o,n[o].status=3,n[o].abortReason="set"):(T(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(Qn(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&r.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));s===-1?Dy(e,void 0):n.length=s+1,qt(t.eventQueue_,$s(e),i);for(let o=0;o<r.length;o++)gi(r[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gP(t){lk(hi),ni(new ir("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return cP(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),In(Tp,kp,t),In(Tp,kp,"esm2017")}zt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};zt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};gP();function Nh(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(t);i<r.length;i++)e.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(t,r[i])&&(n[r[i]]=t[r[i]]);return n}function Ky(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const _P=Ky,Qy=new Us("auth","Firebase",Ky());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gs{constructor(e,n){this.shortDelay=e,this.longDelay=n,Kt(n>e,"Short delay should be less than long delay!"),this.isMobile=Ud()||rv()}get(){return wP()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ph(t,e){Kt(t.emulator,"Emulator should always be set here");const{url:n}=t.emulator;return e?`${n}${e.startsWith("/")?e.slice(1):e}`:n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dm=new Map;function Ut(t){Kt(t instanceof Function,"Expected a class definition");let e=dm.get(t);return e?(Kt(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,dm.set(t,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mw(t,e,n=!1){if(Tt(t.app))return Promise.reject(Bt(t));const r="signIn",i=await pw(t,r,e),s=await hr._fromIdTokenResponse(t,r,i);return n||await t._updateCurrentUser(s.user),s}async function hx(t,e){return mw(_r(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dx(t,e){return e?Ut(e):(A(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jx="pendingRedirect",Uo=new Map;class zx extends Tw{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=Uo.get(this.auth._key());if(!e){try{const r=await Bx(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}Uo.set(this.auth._key(),e)}return this.bypassAuthState||Uo.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Bx(t,e){const n=Hx(e),r=Vx(t);if(!await r._isAvailable())return!1;const i=await r._get(n)==="true";return await r._remove(n),i}function Wx(t,e){Uo.set(t._key(),e)}function Vx(t){return Ut(t._redirectPersistence)}function Hx(t){return Fo(jx,t.config.apiKey,t.name)}async function $x(t,e,n=!1){if(Tt(t.app))return Promise.reject(Bt(t));const r=_r(t),i=Dx(r,e),o=await new zx(r,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
